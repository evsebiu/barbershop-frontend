...
const EditAppointment = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const appRes = await fetch(`http://192.168.1.130:8080/api/appointments/${id}`, { 
                    credentials: 'include' 
                });
                ...
                const srvRes = await fetch(`http://192.168.1.130:8080/api/services`, { 
                    credentials: 'include' 
                });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch(`http://192.168.1.130:8080/api/appointments/${id}`, {
                method: 'PUT',
